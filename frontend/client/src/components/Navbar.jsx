  ...
  return (
    <nav className="bg-[#1E1E1E] text-[#FFFFFF] px-6 py-4 flex items-center justify-between shadow-lg border-b border-[#333333]">
      ...
      <button
        ...
        className="md:hidden text-[#FFFFFF] hover:text-[#FFB400] transition-colors duration-200"
      >
      ...
      {/* Mobile Menu Overlay */}
      {isMobileMenuOpen && (
        <div className="absolute top-full left-0 right-0 bg-[#1E1E1E] border-b border-[#333333] md:hidden z-50">
          <div className="flex flex-col p-4 space-y-2">
            ...
            <button
              ...
              className="bg-[#E94560] hover:bg-[#FFB400] text-white hover:text-black px-4 py-3 rounded-lg font-medium transition-all duration-200 flex items-center gap-3 mt-4"
            >
              <LogOut className="w-5 h-5" />
              <span>Logout</span>
            </button>
