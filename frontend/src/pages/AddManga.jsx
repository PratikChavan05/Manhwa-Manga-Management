...
const AddManga = () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case "Reading": return "#E94560";
      case "Completed": return "#00D4AA";
      case "Paused": return "#FFB400";
      default: return "#B3B3B3";
    }
  };

  return (
    <div style={{ backgroundColor: "#121212", minHeight: "100vh", color: "#FFFFFF" }} className="p-6">
      {/* Header */}
      <div className="flex items-center gap-6 mb-12">
        <button 
          ...
          style={{ backgroundColor: "#1E1E1E", border: "1px solid rgba(233, 69, 96, 0.2)" }}
        >
          <ArrowLeft className="w-5 h-5 transition-colors duration-300 group-hover:text-white" style={{ color: "#B3B3B3" }} />
        </button>
        <div>
          <h1 className="text-4xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
            Add New Manga
          </h1>
          <p style={{ color: "#B3B3B3" }} className="text-base mt-2 font-medium">
      ...
      >
        ...
        <div className="space-y-8 relative">
          ...
          <div className="space-y-3">
            <label className="flex items-center gap-3 text-base font-semibold" style={{ color: "#FFFFFF" }}>
              <div className="p-2 rounded-lg" style={{ backgroundColor: "rgba(233, 69, 96, 0.2)" }}>
          ...
          <div className="space-y-3">
            <label className="flex items-center gap-3 text-base font-semibold" style={{ color: "#FFFFFF" }}>
              <div className="p-2 rounded-lg" style={{ backgroundColor: "rgba(255, 180, 0, 0.2)" }}>
          ...
          {/* Status and Chapter Row */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Status Select */}
            <div className="space-y-3">
              <label className="flex items-center gap-3 text-base font-semibold" style={{ color: "#FFFFFF" }}>
                <div className="p-2 rounded-lg" style={{ backgroundColor: `${getStatusColor(form.status)}20` }}>
                  <FaRoad className="w-5 h-5" style={{ color: getStatusColor(form.status) }} />
                </div>
              ...
              <select
                ...
                onFocus={(e) => {
                  ...
                  e.target.style.boxShadow = `0 0 0 3px ${getStatusColor(form.status)}20`;
                }}
                onBlur={(e) => {
                  e.target.style.borderColor = "#333333";
                  e.target.style.boxShadow = "none";
            ...
            <div className="space-y-3">
              ...
              <input
                ...
                onChange={e => setForm({ ...form, currentChapter: parseInt(e.target.value) })}
                onFocus={(e) => {
                  e.target.style.borderColor = "#E94560";
                  e.target.style.boxShadow = "0 0 0 3px rgba(233, 69, 96, 0.1)";
                }}
          ...
          <div className="space-y-3">
            <label className="flex items-center gap-3 text-base font-semibold" style={{ color: "#FFFFFF" }}>
              ...
              Cover Image URL
              <span className="text-sm font-normal px-2 py-1 rounded-full" style={{ backgroundColor: "rgba(179, 179, 179, 0.2)", color: "#B3B3B3" }}>
                Optional
              </span>
            </label>
            <input
          ...
          <div className="space-y-3">
            <label className="flex items-center gap-3 text-base font-semibold" style={{ color: "#FFFFFF" }}>
              <div className="p-2 rounded-lg" style={{ backgroundColor: "rgba(179, 179, 179, 0.2)" }}>
          ...
          <div className="pt-6">
            <button
              ...
              style={{ 
                ...
                boxShadow: isSubmitting || !form.title.trim() ? 'none' : '0 10px 40px rgba(233, 69, 96, 0.4)',
                background: isSubmitting || !form.title.trim() 
                  ? "#E94560" 
      ...
      <div className="max-w-3xl mx-auto mt-8 text-center">
        <p className="text-base font-medium" style={{ color: "#B3B3B3" }}>
          Fields marked with * are required • Cover image and other details are optional
        </p>
      </div>
    </div>
  );
